...
<body>
    ...
    <div id="body">
                    ...
                    <form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
                        <table>
                            <tr>
                                ...
                                <td>
                                    <select name="os0">
                                        <option value="Red 999">Red 999</option>
                                        <option value="Black 999">Black 999</option>
                                        <option value="Red 999t">Red 999t</option>
                                        <option value="Black999t">Black 999t</option>
                                    </select>
                                </td>
                            </tr>
                        </table>
                    ...
                    <form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
                        <table>
                            <tr>
                                ...
                                <td>
                                    <select name="os0">
                                        <option value="Red 1.4mm">Red (1.4mm)</option>
                                        <option value="Red 1.5mm">Red (1.5mm)</option>
                                        <option value="Black 1.4mm">Black (1.4mm)</option>
                                        <option value="Black 1.5mm">Black (1.5mm)</option>
                                    </select>
                                </td>
                            </tr>
                        </table>
        ...
        <table class="product">
            <tr>
                <td class="prodname" colspan="2">
                    Air Supersoft 30 and Air Lemon 38
                </td>
            </tr>
            <tr>
                <td class="body">
                    ...
                    <form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
                        <table>
                            <tr>
                                <td>
                                    <input type="hidden" name="on0" value="Hardness/Thickness">Thickness/Hardness
                                </td>
                                <td>
                                    <select name="os0">
                ...
                <td class="body">
                    ...
                    <form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
                        <table>
                            <tr>
                                <td>
                                    <input type="hidden" name="on0" value="Thickness">Thickness
                                </td>
                                <td>
                                    <select name="os0">
