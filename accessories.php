		...
		<tr>
			<td class="body">
				...
				<form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
					...
					<input type="hidden" name="item_name" value="Net/Post Heavy Clip">
...
<table class="product">
		...
		<tr>
			...
			Galaxy edge tape.  Nice design.  Still just the ribbon material, but 10mm and at least it looks nice.  I also have some red edge tape that's plain looking but is the more protective, fibrous material
...
As high a quality water glue as I've seen across several brands.  I personally spread with my fingers but you may use
