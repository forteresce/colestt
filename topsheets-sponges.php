...
<body>
    ...
    <div id="body">
        ...
        <table class="product">
            <tr>
                <td class="prodname" colspan="2">999 and 999t</td>
            </tr>
            <tr>
                <td class="body">
                    <span class="price">
                    ...
                    <form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
                        <table>
                            <tr>
                                ...
                                <td><select name="os0"><option value="Red 999">Red 999</option><option value="Black 999">Black 999</option><option value="Red 999t">Red 999t</option><option value="Black999t">Black 999t</option></select></td>
                            </tr>
                        </table>
                        ...
                        <input type="hidden" name="item_name" value="999 and 999t">
        ...
        <table class="product">
            <tr>
                <td class="prodname" colspan="2">Regular Palio CJ8000</td>
            </tr>
            <tr>
                <td class="body">
                    <span class="price">
                    ...
                    <form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
                        ...
                        <input type="hidden" name="cmd" value="_cart">
                        <input type="hidden" name="business" value="cole.ely@gmail.com">
                        <input type="hidden" name="item_name" value="Regular Palio Top">
        ...
        <table class="product">
            <tr>
                <td class="prodname" colspan="2">Palio CJ8000 - Quality B,C</td>
            </tr>
            <tr>
                <td class="body">
                    <span class="price">
                    ...
                    <form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
                        <table>
                            <tr>
                                <td><input type="hidden" name="on0" value="Color">Color</td>
                                <td><select name="os0"><option value="Red 1.4mm">Red (1.4mm)</option><option value="Red 1.5mm">Red (1.5mm)</option><option value="Black 1.4mm">Black (1.4mm)</option><option value="Black 1.5mm">Black (1.5mm)</option></select></td>
                            </tr>
                        </table>
                        <input type="image" src="https://www.paypal.com/en_US/i/btn/x-click-but22.gif" border="0" name="submit" alt="Make payments with PayPal - it's fast, free and secure!">
                        <img alt="" border="0" src="https://www.paypal.com/en_US/i/scr/pixel.gif" width="1" height="1">
                        ...
                        <input type="hidden" name="cmd" value="_cart">
                        <input type="hidden" name="business" value="cole.ely@gmail.com">
                        <input type="hidden" name="item_name" value="Palio CJ8000">
        ...
        <table class="product">
            <tr>
                <td class="prodname" colspan="2">LKT Pro XT and XP tops</td>
            </tr>
            <tr>
                <td class="body">
                    <span class="price">
                    ...
                    <form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
                        <table>
                            ...
                            <tr>
                                ...
                                <td><select name="os1"><option value="XT">XT<option value="XP">XP</select></td>
                            </tr>
                        </table>
                        <input type="image" src="https://www.paypal.com/en_US/i/btn/x-click-but22.gif" border="0" name="submit" alt="Make payments with PayPal - it's fast, free and secure!">
                        <img alt="" border="0" src="https://www.paypal.com/en_US/i/scr/pixel.gif" width="1" height="1">
                        ...
                        <input type="hidden" name="cmd" value="_cart">
                        <input type="hidden" name="business" value="cole.ely@gmail.com">
                        <input type="hidden" name="item_name" value="LKT XP/XT">
                        <input type="hidden" name="amount" value="8.00">
                        <input type="hidden" name="no_note" value="1">
                        <input type="hidden" name="currency_code" value="USD">
                        <input type="hidden" name="bn" value="PP-ShopCartBF">
        ...
        <table class="product">
            <tr>
                <td class="prodname" colspan="2">729 FX</td>
            </tr>
            <tr>
                <td class="body">
                    <span class="price">
                    ...
                    <form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
                        ...
                        <input type="hidden" name="cmd" value="_cart">
                        <input type="hidden" name="business" value="cole.ely@gmail.com">
                        <input type="hidden" name="item_name" value="729 fx">
        ...
        <br /><br />
        <a name="sponges" id="sponges"></a><br />
        <img src="images/title/sponges.gif" /><br /><br />
        
        <table class="product">
            <tr>
                <td class="prodname" colspan="2">AIR Zero Sponge</td>
            </tr>
            <tr>
                <td class="body">
                    <span class="price">
                    ...
                    <form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
                        <table>
                            <tr>
                                <td><input type="hidden" name="on0" value="Hardness/Thickness">Thickness/Hardness</td>
                                <td><select name="os0"><option value="0.6mm">0.6mm<option value="1.0mm">1.0mm<option value="1.2mm">1.2mm<option value="1.5mm">1.5mm</select></td>
                            </tr>
                        </table>
                        <input type="image" src="https://www.paypal.com/en_US/i/btn/x-click-but22.gif" border="0" name="submit" alt="Make payments with PayPal - it's fast, free and secure!">
                        <img alt="" border="0" src="https://www.paypal.com/en_US/i/scr/pixel.gif" width="1" height="1">
                        ...
                        <input type="hidden" name="cmd" value="_cart">
                        <input type="hidden" name="business" value="cole.ely@gmail.com">
                        <input type="hidden" name="item_name" value="zero sponge">
        ...
        <table class="product">
            <tr>
                <td class="prodname" colspan="2">Dawei Quattro</td>
            </tr>
            <tr>
                <td class="body">
                    <span class="price">
                    ...
                    <form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
                        <table>
                            <tr>
                                <td><input type="hidden" name="on0" value="Hardness/Thickness">Thickness/Hardness</td>
                                <td><select name="os0"><option value="1.8mm 35deg">1.8mm 35deg<option value="1.8mm 40deg">1.8mm 40deg<option value="2.0mm 35deg">2.0mm 35deg<option value="2.0mm 40deg">2.0mm 40deg<option value="2.2mm 35deg">2.2mm 35deg<option value="2.2mm 40deg">2.2mm 40deg<option value="2.2mm 42deg">2.2mm 42deg<option value="2.3mm 35deg">2.3mm 35deg<option value="2.3mm 40deg">2.3mm 40deg</select></td>
                            </tr>
                        </table>
                        <input type="image" src="https://www.paypal.com/en_US/i/btn/x-click-but22.gif" border="0" name="submit" alt="Make payments with PayPal - it's fast, free and secure!">
                        <img alt="" border="0" src="https://www.paypal.com/en_US/i/scr/pixel.gif" width="1" height="1">
                        ...
                        <input type="hidden" name="cmd" value="_cart">
                        <input type="hidden" name="business" value="cole.ely@gmail.com">
                        <input type="hidden" name="item_name" value="Dawei Quattro sponge">
        ...
        <table class="product">
            <tr>
                <td class="prodname" colspan="2">Air Supersoft 30 and Air Lemon 38</td>
            </tr>
            <tr>
                <td class="body">
                    <span class="price">
                    ...
                    <form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
                        <table>
                            <tr>
                                <td><input type="hidden" name="on0" value="Hardness/Thickness">Thickness/Hardness</td>
                                <td><select name="os0"><option value="1.2mm 30deg ">1.2mm 30deg<option value="1.5mm 30deg">1.5mm 30deg<option value="1.8mm 30deg">1.8mm 30deg<option value="2.0mm 30deg">2.0mm 30deg<option value="2.2mm 30deg">2.2mm 30deg<option value="2.3mm 30deg">2.3mm 30deg<option value="1.8mm 38deg">1.8mm 38deg<option value="2.0mm 38deg">2.0mm 38deg<option value="2.2mm 38deg">2.2mm 38deg<option value="2.3mm 38deg">2.3mm 38deg</select></td>
                            </tr>
                        </table>
                        <input type="image" src="https://www.paypal.com/en_US/i/btn/x-click-but22.gif" border="0" name="submit" alt="Make payments with PayPal - it's fast, free and secure!">
                        <img alt="" border="0" src="https://www.paypal.com/en_US/i/scr/pixel.gif" width="1" height="1">
                        ...
                        <input type="hidden" name="cmd" value="_cart">
                        <input type="hidden" name="business" value="cole.ely@gmail.com">
                        <input type="hidden" name="item_name" value="Lemon/Supersoft sponge">
                        <input type="hidden" name="amount" value="10.00">
                        <input type="hidden" name="no_note" value="1">
                        <input type="hidden" name="currency_code" value="USD">
                        <input type="hidden" name="bn" value="PP-ShopCartBF">
        ...
        <table class="product">
            <tr>
                <td class="prodname" colspan="2">Dawei Lightning (Cannon)</td>
            </tr>
            <tr>
                <td class="body">
                    <span class="price">
                    ...
                    <form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
                        <table>
                            <tr>
                                <td><input type="hidden" name="on0" value="Thickness">Thickness</td>
                                <td><select name="os0"><option value="0.6mm">0.6mm<option value="1.0mm">1.0mm<option value="1.2mm">1.2mm<option value="1.5mm">1.5mm<option value="1.8mm">1.8mm<option value="2.0mm">2.0mm<option value="2.2mm">2.2mm</select></td>
                            </tr>
                        </table>
                        <input type="image" src="https://www.paypal.com/en_US/i/btn/x-click-but22.gif" border="0" name="submit" alt="Make payments with PayPal - it's fast, free and secure!">
                        <img alt="" border="0" src="https://www.paypal.com/en_US/i/scr/pixel.gif" width="1" height="1">
                        ...
                        <input type="hidden" name="cmd" value="_cart">
                        <input type="hidden" name="business" value="cole.ely@gmail.com">
                        <input type="hidden" name="item_name" value="Dawei Lightning sponge">
                        <input type="hidden" name="amount" value="5.00">
                        <input type="hidden" name="no_note" value="1">
                        <input type="hidden" name="currency_code" value="USD">
                        <input type="hidden" name="bn" value="PP-ShopCartBF">i
                    </form>
                    <br />
